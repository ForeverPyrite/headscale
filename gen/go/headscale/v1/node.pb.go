...
func (x *SetNodeIPRequest) GetIpAddresses() []string {
	if x != nil {
		return x.IpAddresses
	}
	return nil
...
const file_headscale_v1_node_proto_rawDesc = "" +
	...
	"\achanges\x18\x01 \x03(\tR\achanges\"N\n" +
	"\x10SetNodeIPRequest\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\x04R\x06nodeId\x12!\n" +
	"\fip_addresses\x18\x02 \x03(\tR\vipAddresses\";\n" +
...
var file_headscale_v1_node_proto_goTypes = []any{
	...
	(*SetNodeIPRequest)(nil),          // 22: headscale.v1.SetNodeIPRequest
	(*SetNodeIPResponse)(nil),         // 23: headscale.v1.SetNodeIPResponse
...
var file_headscale_v1_node_proto_depIdxs = []int32{
	...
	1,  // 15: headscale.v1.SetNodeIPResponse.node:type_name -> headscale.v1.Node
